        ...
        <div className="banner-current-page box-element">
          ...
          <div className="current-page-box">
            ...
            <div className="current-page-box-link">
              ...
              <span className="current-page"> Giày</span>
            </div>
          </div>
        </div>
            ...
            <div className="filter-box">
              ...
              <ul className="list-cate" id="filterCate">
                <li>
                  ...
                  <label htmlFor="">Mousse Cake.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh flan.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh Cookies.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh Tiramisu.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh Muffin.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh Tart.</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh-Cheese</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bánh Panna Cotta.</label>
                </li>
              </ul>
            </div>
            <div className="filter-box">
              ...
              <ul className="list-cate" id="filterCate">
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bò Khô</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Gà Khô</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Sốt Vang</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Hướng Dương Nguyên Vị</label>
                </li>
              </ul>
            </div>
          </div>
                  ...
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="detailProduct.html">
                        <img
                          src="./img/img-đồ-ăn/banh-kem-crepe scola.webp"
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Bánh Kem Crep Socola</h5>
                      </a>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="detailProduct.html">
                        <img
                          src="./img/img-đồ-ăn/banh-my-pho-mai.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">BÁnh Mỳ Phô Mai</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>30.000 </span>₫
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-đồ-ăn/banh-ngot-paty.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Bánh Ngọt Paty</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>50.000 </span>₫
                ...
                <div className="product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/Banh-Cheese.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Banh Chesee</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>40.000 </span>₫
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/banh-cookies.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Cooker</h5>
                      <p className="card-text">
                        {" "}
                        <span>35.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/banh-flan.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Plan</h5>
                      <p className="card-text">
                        {" "}
                        <span>40.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/Bánh Muffin..jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh MUfin</h5>
                      <p className="card-text">
                        {" "}
                        <span>35.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/Bánh Tart..jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Tart</h5>
                      <p className="card-text">
                        {" "}
                        <span>35.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/Bánh Tiramisu..jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Tiramisu</h5>
                      <p className="card-text">
                        {" "}
                        <span>40.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/Mousse Cake..jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title"> Bánh Mousse </h5>
                      <p className="card-text">
                        {" "}
                        <span>35.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img-banh/panna-cotta.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Pana Cotta </h5>
                      <p className="card-text">
                        {" "}
                        <span>40.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bánh Bao Chứng Muối</h5>
                      <p className="card-text">
                        {" "}
                        <span>15.000 </span>₫
                      </p>
