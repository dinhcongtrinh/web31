            ...
            <div className="navbar-nav navbar-menu">
              ...
              <div className="nav-item dropdown ">
                ...
                >
                  ...
                  <a href="pant.html">Đồ Uống</a>
                  <a href="douong.html">Đồ Ăn</a>
        ...
        <div className="banner-current-page box-element">
          ...
          <div className="current-page-box">
            ...
            <div className="current-page-box-link">
              ...
              <span className="current-page"> Xuất khẩu</span>
            </div>
          </div>
        </div>
            ...
            <div className="filter-box">
              ...
              <ul className="list-cate" id="filterCate">
                <li>
                  ...
                  <label htmlFor="">Abrica</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Robusta</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Cà Phê Chồn</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">An Nhiên Cà Phê</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Uniqlo</label>
                </li>
              </ul>
            </div>
          </div>
                  ...
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="detailProduct.html">
                        <img
                          src="./img/img.sp/abrica-cfbouside.jpg"
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Abrica Rang Hạt</h5>
                      </a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">cà Phê Cao Cấp</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>600.000 </span>₫
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/robusta-bouside.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Robusta Rang Hạt</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>450.000 </span>₫
                ...
                <div className="product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/Abrica-chapi.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Abrica Chapi</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>470.000 </span>₫
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/abricacf-caudat.png"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Abrica Cầu Đất</h5>
                      <p className="card-text">
                        {" "}
                        <span>400.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/abricacf-daiphat.jpeg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/robustacf-hươngvietj.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Robusta Hương Việt</h5>
                      <p className="card-text">
                        {" "}
                        <span>60.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/abricacf-rey.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Robusta Rang Mộc</h5>
                      <p className="card-text">
                        {" "}
                        <span>460.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/robustacf-motheriend.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Robusta Retro</h5>
                      <p className="card-text">
                        {" "}
                        <span>490.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Coffee Reproad </h5>
                      <p className="card-text">
                        {" "}
                        <span>560.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/img.sp/abricacf-mothelancaocap.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title"> Abrica NotherLand Cao Cấp</h5>
                      <p className="card-text">
                        {" "}
                        <span>620.000 </span>₫
                      </p>
