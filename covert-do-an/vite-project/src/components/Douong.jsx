...
export default function Douong() {
  return (
    <div><>
    ...
    <main>
      <div className="container">
        <div className="banner-current-page box-element">
          ...
          <div className="current-page-box">
            ...
            <div className="current-page-box-link">
              ...
              <span className="current-page"> Đồ Uống</span>
            </div>
          </div>
        </div>
        <div className="row mb-4 search-order-box">
          ...
          <div className="col-lg-3 col-md-4 col-sm-6">
            <div className="form-group order-by">
              <select id="my-select" className="custom-select" name=""></select>
        ...
        <div className="row box-element">
          <div
            className="col-lg-3 col-md-4 col-sm-12 filter-box-all"
            id="optionFilterBox"
          >
            <div className="filter-box">
              <div className="filter-title">
                <h5>Trà</h5>
                <button
                  className="btn-active-filter-box"
                  style={{ outline: "none" }}
                >
                  -
                </button>
              </div>
              <ul className="list-cate" id="filterCate">
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Cam Đào</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Cam Xả</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Trà sữa</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Thảo Dược</label>
                </li>
              </ul>
            </div>
            <div className="filter-box">
              ...
              <ul className="list-cate" id="filterCate">
                ...
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Bạc Sửu</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Amenicano</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Capuchino</label>
                </li>
              </ul>
            </div>
            ...
            <div className="filter-box">
              ...
              <ul className="list-cate" id="filterCate">
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Cam</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Dứa</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Soài</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Detox3</label>
                </li>
                <li>
                  <input type="checkbox" className="" />
                  <label htmlFor="">Detox4</label>
                </li>
              </ul>
            </div>
          </div>
                  ...
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="detailProduct.html">
                        <img
                          src="./img/do-uong/dt-buoi-hong.jpg"
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Danh trà bưởi hồng</h5>
                      </a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Cam Quế</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className="product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="detailProduct.html">
                        <h5 className="card-title">Cam Xả</h5>
                      </a>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Capuchino</h5>
                      <p className="card-text">
                        {" "}
                        <span>35.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Đen Nóng</h5>
                      <p className="card-text">
                        {" "}
                        <span>28.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Nâu Đá</h5>
                      <p className="card-text">
                        {" "}
                        <span>28.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/do-uong/Sữa-chu-đb.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Sữa Chua Đặc Biệt</h5>
                      <p className="card-text">
                        {" "}
                        <span>1.000.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/do-uong/tr-com-dua.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Trà Cốm Dừa</h5>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/do-uong/tr-hoa-qua-tpnhadam.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Trà Hoa Quả</h5>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/detox/bơ-chuối-dâu-tây.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Bơ Chuối Dâu Tây</h5>
                      <p className="card-text">
                        {" "}
                        <span>50.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/detox/dt-cân-tây-tao-cam.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Cần Tây Táo Cam</h5>
                      <p className="card-text">
                        {" "}
                        <span>50.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Táo Dứa Chanh Leo</h5>
                      <p className="card-text">
                        {" "}
                        <span>50.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Sữa Chua Đặc Biệt Dâu </h5>
                      <p className="card-text">
                        {" "}
                        <span>59.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Chanh Tươi</h5>
                      <p className="card-text">
                        {" "}
                        <span>40.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Epreesoo</h5>
                      <p className="card-text">
                        {" "}
                        <span>29.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/tra-sua/tr-sưa-tươ-cc.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Trà Sữa Chân Châu</h5>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
                      </p>
                ...
                <div className=" product-item">
                  <div className="card" style={{}}>
                    <div className="card-img">
                      <a href="">
                        <img
                          src="./img/tra-sua/ts-chese-nương.jpg"
                          className="card-img-top"
                          alt="..."
                        />
                      </a>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Trà Sữa Chesee Nướng</h5>
                      <p className="card-text">
                        {" "}
                        <span>45.000 </span>₫
                      </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 item">
                <div className=" product-item">
                  <div className="card" style={{}}>
                    ...
                    <div className="card-body">
                      <a href="" />
                      <h5 className="card-title">Nước Ép Cà Rốt</h5>
                      <p className="card-text">
                        {" "}
                        <span>50.000 </span>₫
                      </p>
